...
public class CommandRegistration {
    ...
    private static net.minecraft.network.chat.MutableComponent createInteractiveUsagePlayer(String messageKey, String targetName, String suggestCommand) {
        return net.minecraft.network.chat.Component.empty().append(MessageUtil.get(messageKey, PLAYER, targetName))
            .withStyle(s -> s.withColor(net.minecraft.ChatFormatting.RED)
                ...
                .withHoverEvent(new net.minecraft.network.chat.HoverEvent(net.minecraft.network.chat.HoverEvent.Action.SHOW_TEXT, net.minecraft.network.chat.Component.empty().append(MessageUtil.get("click-to-autofill")).withStyle(net.minecraft.ChatFormatting.GRAY))));
    }


    private static net.minecraft.network.chat.MutableComponent createInteractiveUsage(String messageKey, String suggestCommand) {
        return net.minecraft.network.chat.Component.empty().append(MessageUtil.get(messageKey))
            .withStyle(s -> s.withColor(net.minecraft.ChatFormatting.RED)
                .withClickEvent(new net.minecraft.network.chat.ClickEvent(net.minecraft.network.chat.ClickEvent.Action.SUGGEST_COMMAND, suggestCommand))
                .withHoverEvent(new net.minecraft.network.chat.HoverEvent(net.minecraft.network.chat.HoverEvent.Action.SHOW_TEXT, net.minecraft.network.chat.Component.empty().append(MessageUtil.get("click-to-autofill")).withStyle(net.minecraft.ChatFormatting.GRAY))));
    }
    ...
    private static void registerReviveCommand(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("revive")
            ...
            .executes(context -> {
                context.getSource().sendFailure(createInteractiveUsage("usage-revive", "/revive "));
                return 0;
            })
            .then(Commands.argument(PLAYER, StringArgumentType.word())
                .suggests((context, builder) -> SharedSuggestionProvider.suggest(
    ...
    private static void registerSetLivesCommand(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("psetlives")
            .requires(source -> source.hasPermission(2))
            .executes(context -> {
                context.getSource().sendFailure(createInteractiveUsage("usage-psetlives", "/psetlives "));
                return 0;
            })
            .then(Commands.argument(PLAYER, StringArgumentType.word())
                .suggests((context, builder) -> SharedSuggestionProvider.suggest(
                ...
                .executes(context -> {
                    String targetName = StringArgumentType.getString(context, PLAYER);
                    context.getSource().sendFailure(createInteractiveUsagePlayer("usage-psetlives-player", targetName, "/psetlives " + targetName + " "));
                    return 0;
                })
